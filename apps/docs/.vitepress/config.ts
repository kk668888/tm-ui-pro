...
export default defineConfig({
  ...
  vite: {
    ssr: {
      ...
      // `renderToString(<TmTable>)` 会因 vxe / @trustmo/tm-ui 命名 export 无法解析而报错。
      noExternal: [
        '@trustmo/tm-ui',
        'ant-design-vue',
      ...
      '/components/': [
        {
          ...
          items: [
            ...
            { text: 'InputPassword 密码输入框', link: '/components/input-password' },
        ...
        },
        {
          text: '子组件 & 模板写法',
          items: [
            { text: 'SelectOption 下拉选项', link: '/components/select-option' },
            { text: 'SelectOptGroup 下拉选项分组', link: '/components/select-opt-group' },
            { text: 'AutoCompleteOption 候选项', link: '/components/auto-complete-option' },
            { text: 'AutoCompleteOptGroup 候选分组', link: '/components/auto-complete-opt-group' },
            { text: 'TreeNode 树节点', link: '/components/tree-node' },
            { text: 'TreeSelectNode 树选择节点', link: '/components/tree-select-node' },
            { text: 'TimelineItem 时间线条目', link: '/components/timeline-item' },
            { text: 'BadgeRibbon 缎带徽标', link: '/components/badge-ribbon' },
            { text: 'CardGrid 卡片栅格单元', link: '/components/card-grid' },
            { text: 'CardMeta 卡片元信息', link: '/components/card-meta' },
            { text: 'TableColumn 表格列', link: '/components/table-column' },
            { text: 'TableColumnGroup 表头分组', link: '/components/table-column-group' },
            { text: 'TableSummary 总结栏容器', link: '/components/table-summary' },
            { text: 'TableSummaryRow 总结栏行', link: '/components/table-summary-row' },
            { text: 'TableSummaryCell 总结栏单元格', link: '/components/table-summary-cell' },
            ...
            { text: 'Compact 紧凑排布容器', link: '/components/compact' },
            { text: 'FormItemRest 采集豁免区', link: '/components/form-item-rest' },
            { text: 'SkeletonTitle 骨架标题条', link: '/components/skeleton-title' },
            { text: 'Textarea 多行文本域', link: '/components/textarea' },
            { text: 'CheckableTag 可选中标签', link: '/components/checkable-tag' },
            { text: 'MonthPicker 月份选择器', link: '/components/month-picker' },
            { text: 'WeekPicker 周选择器', link: '/components/week-picker' },
            { text: 'QuarterPicker 季度选择器', link: '/components/quarter-picker' },
            { text: 'TimeRangePicker 时间范围选择器', link: '/components/time-range-picker' },
            { text: 'UploadDragger 拖拽上传区', link: '/components/upload-dragger' },
            { text: 'RadioButton 按钮态单选', link: '/components/radio-button' },
          ],
        },
      ],
    },
